...
class ImageSetsTests(unittest.TestCase):
    def test_rgb_returns_rgb_files(self):
        self.assertEquals(["0000085b-6f4a-475a-b800-9ed7619e8a67_rgb_2013.tiff",
                          ...
                          ImageSets(r"TestData/2013").rgb.images)

    def test_rgb_mask_returns_mask_files(self):
        self.assertEquals(["0000085b-6f4a-475a-b800-9ed7619e8a67_rgb_2013_mask.tiff",
                          ...
                          ImageSets(r"TestData/2013").rgb.masks)

    def test_rgb_masked_returns_masked_files(self):
        self.assertEquals(["0000085b-6f4a-475a-b800-9ed7619e8a67_rgb_2013_masked.tiff",
                          ...
                          ImageSets(r"TestData/2013").rgb.masked)


    def test_ir_returns_ir_files(self):
        self.assertEquals(["0000085b-6f4a-475a-b800-9ed7619e8a67_ir_2013.tiff",
                          ...
                          ImageSets(r"TestData/2013").ir.images)

    def test_ir_mask_returns_mask_files(self):
        self.assertEquals(["0000085b-6f4a-475a-b800-9ed7619e8a67_ir_2013_mask.tiff",
                          ...
                          ImageSets(r"TestData/2013").ir.masks)

    def test_ir_masked_returns_masked_files(self):
        self.assertEquals(["0000085b-6f4a-475a-b800-9ed7619e8a67_ir_2013_masked.tiff",
                          ...
                          ImageSets(r"TestData/2013").ir.masked)
